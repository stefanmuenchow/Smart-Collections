...
public interface ImmutableSmartCollection<E> {
    ...
    public SmartCollection<E> remove(final Object o);
    public boolean containsAll(final Collection<?> c);
    public SmartCollection<E> union(final Collection<? extends E> c);
    public SmartCollection<E> difference(final Collection<?> c);
    public SmartCollection<E> intersection(final Collection<?> c);
    public void clear();
